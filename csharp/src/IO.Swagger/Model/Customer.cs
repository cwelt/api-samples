...
namespace IO.Swagger.Model
{
    ...
    public partial class Customer :  IEquatable<Customer>, IValidatableObject
    {
        ...
        public Customer(int? customerId = default(int?), decimal? accountValue = default(decimal?), string customerName = default(string), bool? active = default(bool?), InlineResponse200Address address = default(InlineResponse200Address), List<InlineResponse200Contacts> contacts = default(List<InlineResponse200Contacts>))
        {
